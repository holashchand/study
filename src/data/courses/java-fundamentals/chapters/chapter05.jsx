...
export const sections = [
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>1. Classes and Objects</h2>
...
System.out.println(c1.color.equals(c3.color));  // true — same value</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>2. Fields: Instance vs Static</h2>
...
Constants c;  // prints: "Constants class loaded..."</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>3. Constructors</h2>
...
System.out.println(p.name);  // "Alice" — correctly assigned</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>4. The this Keyword</h2>
...
// Output: Connecting to prod.example.com:5432/analytics (SSL=true)</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>5. Access Modifiers</h2>
...
└─────────────────────────────────────────────────────────────┘
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>6. Encapsulation</h2>
...
int px = p.x();  // getter is x(), not getX()</code></pre>
  ...
  },
  {
    ...
    title: '7. Inheritance',
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>7. Inheritance</h2>
...
System.out.println(tri.area());        // 25 — Triangle's implementation</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>8. The super Keyword</h2>
...
System.out.println(mgr.getSalary());  // 110000.0</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>9. Method Overriding</h2>
...
c.method(5, 10);  // Child: int, int (overloading)</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>10. Polymorphism</h2>
...
// Same method, different implementations based on actual type</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>11. Object Casting</h2>
...
for (Animal animal : typedAnimals) {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>12. Object Class Methods</h2>
...
for (Person p : people) {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>13. Abstract Classes</h2>
...
dog.sleep();      // Zzz</code></pre>
  ...
  },
  {
    ...
    title: '14. Interfaces',
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>14. Interfaces</h2>
...
// Swimming</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>15. Functional Interfaces</h2>
...
System.out.println(sum.apply(1, 2, 3));  // 6</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>16. Sealed Classes <span class="badge">Java 17+</span></h2>
...
double processPayment(PaymentMethod method, double amount) {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>17. Records <span class="badge">Java 16+</span></h2>
...
record Point(int x, int y) implements Comparable&lt;Point&gt; {
  ...
  },
  {
    ...
    title: '18. Enums',
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>18. Enums</h2>
...
System.out.println(p1.ordinal() > p3.ordinal());  // true — 2 > 0</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>19. Nested Classes</h2>
...
outer.r.run();</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>20. final Keyword</h2>
...
final int criticalCalculation(int x) {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>21. Annotations</h2>
...
public void backup() { }</code></pre>` }} />
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>22. Reflection API</h2>
