...
export const sections = [
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>1. What is Java?</h2>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>2. JRE vs JDK vs JVM</h2>
...
javac -version       # Shows compiler version (JDK only)</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>3. JIT Compilation</h2>
...
java HelloWorld          # JVM loads .class, JIT compiles frequently-run methods to native code</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>4. Java Versions Timeline</h2>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>5. Installing the JDK</h2>
...
javac -version</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>6. Hello World — First Program</h2>
...
# Age: 25
# Height: 5.7
# In 10 years, age will be: 35</code></pre>` }} />
    ),
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>7. Compilation Model</h2>
...
javap -c HelloWorld  # Shows the bytecode instructions</code></pre>` }} />
    ),
  },
  {
    id: 'package-system',
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>8. Package System</h2>
...
public class HelloWorld {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>9. Import Statements</h2>
...
public class DateDemo {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>10. Comments &amp; Documentation</h2>
...
# Open doc/index.html in browser to see generated docs</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>11. JShell — Interactive REPL <span class="badge">Java 9+</span></h2>
...
$11 ==> "Hello, Alice"</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>12. Single-File Programs <span class="badge">Java 11+</span></h2>
...
# Output: 98.6°F = 37.0°C</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>13. Command-Line Arguments</h2>
...
# Total: 49.95</code></pre>` }} />
  ...
  },
  {
    ...
    title: 'Summary',
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>Summary</h2>
