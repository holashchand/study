...
export const sections = [
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>1. Method Anatomy</h2>
...
System.out.println(result);</code></pre>` }} />
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>2. Calling Methods</h2>
      <ul>
...
System.out.println(result);    // JAVA</code></pre>` }} />
    ),
  },
  {
    id: 'return-types',
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>3. Return Types</h2>
      <ul>
...
public int getScore(String grade) {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>4. Pass-by-Value Semantics</h2>
...
int[] nums = {10, 20};
swapArray(nums, 0, 1);
System.out.println("nums[0]=" + nums[0] + ", nums[1]=" + nums[1]);  // 20, 10 ✓</code></pre>` }} />
    ),
  },
  {
    id: 'overloading',
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>5. Method Overloading</h2>
      <ul>
...
int[] arr = parser.parseMultiple("1", "2", "3");  // uses parseMultiple</code></pre>` }} />
    ),
  },
  {
    id: 'varargs',
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>6. Varargs (Variable Arguments)</h2>
...
System.out.println(join(", ", "a", "b", "c", "d"));     // a, b, c, d</code></pre>` }} />
    ),
  },
  {
    id: 'recursion',
    title: '7. Recursion',
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>7. Recursion</h2>
...
System.out.println(factorial_iterative(5));    // 120</code></pre>` }} />
    ),
  },
  {
    id: 'arrays-1d',
    title: '8. 1D Arrays',
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>8. 1D Arrays</h2>
      <ul>
...
System.out.println("Passing: " + proc.countPassing(grades));   // 5</code></pre>` }} />
    ),
  },
  {
    id: 'arrays-2d',
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>9. 2D and Jagged Arrays</h2>
      <ul>
...
for (int i = 0; i < cube.length; i++) {           // layers
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>10. java.util.Arrays</h2>
...
// Original changed? false</code></pre>` }} />
    ),
  },
  {
    id: 'array-of-objects',
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>11. Array of Objects</h2>
      <ul>
...
for (String[] row : grid2) {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>12. Common Array Pitfalls</h2>
