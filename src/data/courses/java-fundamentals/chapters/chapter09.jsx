...
export const sections = [
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>1. Process vs Thread</h2>
...
public class ThreadInspection {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>2. Thread Lifecycle</h2>
...
public class ThreadStateDemo {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>3. Creating Threads — 4 Ways</h2>
...
exec.shutdown();
      ...
      <div class="tip">Runnable for fire-and-forget tasks. Callable when you need a result.</div>` }} />
    ),
  },
  {
    id: 'sec-4',
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>4. Thread Methods</h2>
...
Thread.yield();  // current thread yields CPU voluntarily
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>5. Race Conditions</h2>
...
// Between steps 3 and 6, another thread can read the old value!
      ...
      <div class="tip">Solutions: use synchronized, ReentrantLock, or AtomicInteger (see sections 6, 9, 10).</div>` }} />
    ),
  },
  {
    id: 'sec-6',
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>6. synchronized Keyword</h2>
...
class GoodDesign {
    ...
    // Now updateData1 and updateData2 can run concurrently!
      ...
      <div class="warning">Over-synchronization reduces concurrency. Synchronize only the critical section and only what's necessary.</div>` }} />
    ),
  },
  {
    id: 'sec-7',
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>7. volatile Keyword</h2>
...
// Bad use: complex operations (use synchronized instead)
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>8. wait/notify/notifyAll — Producer-Consumer Pattern</h2>
...
Solution: loop (while) ensures we recheck condition
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>9. java.util.concurrent.locks</h2>
...
class ConditionedBuffer {
    ...
    public int consume() throws InterruptedException {
      ...
      <div class="tip">ReentrantLock for explicit unlock, timeout, and multiple conditions. synchronized for simple locking.</div>` }} />
    ),
  },
  {
    id: 'sec-10',
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>10. Atomic Classes</h2>
...
Result: No lost update, both threads see consistent state
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>11. ExecutorService — Thread Pool</h2>
...
exec.shutdown();
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>12. CompletableFuture</h2>
...
customExec.shutdown();
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>13. Concurrent Collections</h2>
...
for (String s : queue) {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>14. Synchronization Aids</h2>
...
// Consumer received: Hello from Producer
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>15. Virtual Threads (Java 21+) <span class="badge">Java 21+</span></h2>
...
// Use ReentrantLock instead
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>16. Structured Concurrency (Java 21+ Preview) <span class="badge">Java 21+</span></h2>
...
try (var scope = new StructuredTaskScope.ShutdownOnSuccess&lt;String&gt;()) {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>17. ThreadLocal</h2>
...
try (MDCCloseable mdc = MDC.putCloseable("userId", id)) {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>18. Common Concurrency Bugs</h2>
