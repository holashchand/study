...
export const sections = [
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>1. Exception Hierarchy</h2>
...
while (true) {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>2. Common Exceptions Table</h2>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>3. try-catch Basics</h2>
...
try {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>4. finally Block</h2>
...
// Output: IllegalArgumentException is thrown, RuntimeException is lost</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>5. Multi-catch (Java 7+)</h2>
...
try {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>6. throw and throws</h2>
...
public void process() throws IOException {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>7. Custom Exceptions</h2>
...
try {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>8. Exception Chaining</h2>
...
try {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>9. try-with-resources (Java 7+)</h2>
...
try (BufferedReader br = new BufferedReader(new FileReader("file.txt"))) {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>10. Helpful NullPointerException (Java 14+)</h2>
...
Optional.ofNullable(user)
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>11. Classic java.io</h2>
...
String content = sb.toString();</code></pre>` }} />
    ),
  },
  {
    id: 'nio2',
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>12. java.nio.file — NIO.2 (Java 7+)</h2>
...
for (String line : lines) {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>13. Serialization</h2>
