...
export const sections = [
  {
    ...
    title: '1. Variables',
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>1. Variables</h2>
...
int my variable;            // ERROR: space not allowed</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>2. The 8 Primitive Types</h2>
  ...
  },
  {
    ...
    title: '3. Literals',
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>3. Literals</h2>
...
int[] array = null;</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>4. Wrapper Classes</h2>
...
int value = opt.orElse(0);         // 0 if null</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>5. Type Casting</h2>
...
try {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>6. var — Local Variable Type Inference (Java 10+)</h2>
...
for (var name : names) {  // var inferred as String
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>7. Arithmetic Operators</h2>
...
long safe = (long) Integer.MAX_VALUE + 1;  // 2147483648 (no overflow)</code></pre>` }} />
    ),
  },
  {
    id: 'unary-operators',
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>8. Unary Operators</h2>
...
System.out.println(~(-5));     // 4</code></pre>` }} />
    ),
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>9. Assignment Operators</h2>
...
value >>>= 1;          // value = value >>> 1 → 2 (0b0010)</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>10. Comparison Operators</h2>
...
if (Objects.equals(s, "test")) {   // safe even if s is null
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>11. Logical Operators</h2>
...
System.out.println(Integer.toBinaryString(x | y));  // 0b1110 (bitwise)</code></pre>` }} />
    ),
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>12. Bitwise Operators</h2>
...
int quarter_x = x >> 2;     // x / 4 = 2</code></pre>` }} />
    ),
  },
  {
    id: 'ternary-operator',
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>13. Ternary Operator</h2>
...
// int result = a ? b : c ? d : e ? f : g;  // avoid!</code></pre>
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>14. instanceof Operator</h2>
...
if (obj instanceof List list) {
  ...
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>15. Operator Precedence</h2>
...
// boolean result = (a > 0) & (b > 0);  // compiles but doesn't short-circuit!</code></pre>` }} />
    ),
  },
  {
    ...
    content: () => (
      <div dangerouslySetInnerHTML={{ __html: `<h2>16. String Concatenation with +</h2>
