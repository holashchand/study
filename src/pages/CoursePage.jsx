    ...
    <AppShell>
      ...
      <main className="mx-auto max-w-4xl px-6 py-10">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs text-muted-foreground font-medium">{course.chapters.length} total</span>
        </div>
        ...
        <div className="rounded-xl border border-border overflow-hidden divide-y divide-border">
          {course.chapters.map((chapter) => (
            <Link
              ...
              className="group flex items-center gap-4 px-5 py-4 bg-card hover:bg-muted/50 transition-colors"
            >
              {/* Chapter number badge */}
              <span className="text-sm font-black text-muted-foreground/40 tabular-nums w-7 shrink-0 text-right select-none">
              ...
              <div className="flex-1 min-w-0">
                ...
                {chapter.subtitle && (
                  <p className="text-xs text-muted-foreground mt-0.5 line-clamp-1">{chapter.subtitle}</p>
                )}
              </div>
